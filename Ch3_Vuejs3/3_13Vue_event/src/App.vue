  ...
  <form v-on:submit.prevent="onSubmit">
    <table>
      <tr>
        <td>user Id</td>
        <td>
          <input tpye="text" v-on:input="userId = $event.target.value" v-bind:value="userId">
        </td>
      </tr>
      <tr>
        <td>password</td>
        <td>
          <input type="password" v-on:change="userPw = $event.target.value" v-bind:value="userPw">
        </td>
      </tr>
      <tr>
        <td>introduce</td>
        <td><textarea rows="5" v-model="introduction"></textarea></td>
      </tr>
      <tr>
        <td>developer ? </td>
        <td>
      ...
      <tr>
        <td>developer ? </td>
        <td>
          <input type="checkbox" v-on:change="handleCheckBox3('check!!!')">
        </td>
      </tr>
      <tr>
        <td>forigner ? </td>
        <td>
          <input type="checkbox" v-on:change="handleCheckBox4('check!!',$event)" true-value="yes" false-value="no">
        </td>
      </tr>
      <tr>
        <td>hobby</td>
